...
def main():
    parser=argparse.ArgumentParser(); parser.add_argument('--output-root',default='ext_ablation/results_strict_loso_seed7'); parser.add_argument('--datasets',default='CHSZ Sleep-EDF-20'); parser.add_argument('--data-root',default='.'); args=parser.parse_args()
