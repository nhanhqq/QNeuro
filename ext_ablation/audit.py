...
def main():
    p=argparse.ArgumentParser(); p.add_argument('--output-root',default='ext_ablation/results_strict_loso_seed7'); p.add_argument('--datasets',default='CHSZ Sleep-EDF-20'); p.add_argument('--data-root',default='.'); a=p.parse_args(); root=Path(a.output_root)
